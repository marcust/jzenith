...
public class MongoDbHealthCheckTest extends AbstractMongoDbPluginTest {
    ...
    public void testHealthCheck() {
        ...
        assertThat(healthCheckResult.isDown()).describedAs(healthCheckResult.toString()).isFalse();
    }
